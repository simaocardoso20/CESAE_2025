...
public class Jogo {
    ...
    public static void introducaoHistoria() {
        ...
        System.out.println("Ano de 1938. A Europa estremece às portas de uma guerra iminente, mas longe das grandes potências,\n"
                + "nos confins do Sudeste Asiático, uma ameaça mais antiga desperta.\n"
                + "O mundo mergulha nas sombras à medida que forças obscuras procuram artefactos lendários.\n"
                + "A Serpente Dourada, uma relíquia amaldiçoada com poderes místicos, reapareceu nos confins de um templo esquecido.\n"
                + "Dizem as lendas locais que a estátua, feita de ouro puro, representa uma deusa-serpente capaz de libertar tempestades tropicais\n"
                + "e despertar um exército adormecido de guerreiros espectrais.\n"
                + "Diz-se que quem a possuir poderá dominar os reinos da vida e da morte...\n"
                + "Cabe-te a ti, corajoso aventureiro, enfrentar este labirinto de perigos e escolher o teu destino.\n"
                + "Boa sorte — o teu caminho começa agora!\n");
    }
    ...
    public static void mostrarRoteiroPersonalizado(Heroi heroi) {
        ...
        System.out.println("No coração da selva peruana, um antigo artefacto – A Serpente Dourada de Uxmal –\n"
                + "foi descoberto por exploradores ilegais.\n"
                + "Diz a lenda que quem a possui controla as forças da natureza.\n");
        ...
        switch (classeHeroi) {
            case "IndianaJones":
                partePersonalizada = "Indiana Jones fará tudo para recuperá-la antes que caia nas mãos erradas, impedindo assim uma catástrofe!!!\n"
                        + "Depois de saber dos perigos que o aguardavam, Indy foi ao mercado procurar o seu amigo de longa data, Tupaq Callani.\n"
                        + "Um velho guia nativo da selva peruana, astuto, leal e com um conhecimento lendário sobre ruínas esquecidas.\n"
                        + "Velho amigo de Indiana Jones, já lhe salvou a vida mais vezes do que ele gosta de admitir.\n"
                        + "Vê o que Tupaq Callani tem para te oferecer, sê sábio na tua escolha!";
                break;
            case "HansVogel":
                partePersonalizada = "Hans Vogel pretende usá-la como arma de dominação mundial,\n"
                        + "moldando o destino da humanidade com punho de ferro!!!\n"
                        + "Calculista, Hans sabia que tinha que estar preparado para enfrentar os perigos que o aguardavam.\n"
                        + "Um velho guia nativo da selva peruana, com um conhecimento lendário sobre ruínas esquecidas,\n"
                        + "encontra-se no mercado e tem tudo o que Hans precisa para atingir os seus objetivos.\n"
                        + "Vê o que o velho peruano tem para te oferecer, sê sábio na tua escolha!";
                break;
            case "SophieValen":
                partePersonalizada = "Sophie Valen vê neste artefacto uma peça vital do seu passado sombrio,\n"
                        + "mas também uma ameaça que poderá destruir tudo!!!\n"
                        + "Sedutora e esperta, Sophie conseguiu convencer o proprietário do hotel onde estava hospedada,\n"
                        + "a fornecer-lhe um conjunto de items raros e proibidos.\n"
                        + "Entre olhares furtivos e palavras sussurradas ao pé do ouvido,\n"
                        + "ela obteve acesso ao velho arsenal escondido no porão do edifício.\n"
                        + "Vê o que o dono do hotel tem para te oferecer, sê sábia na tua escolha!";
                break;
            default:
    ...
    public static void missaoSelva(Heroi heroi) {
        System.out.println("Com os bolsos mais leves (ou não), entras na espessa e abafada selva.\n"
                + "O som distante de tambores tribais mistura-se com os gritos de animais selvagens.\n"
                + "A missão é clara: encontrar o mapa perdido escondido dentro desta floresta traiçoeira.\n"
                + "Dois caminhos surgem à tua frente: ");
        ...
        switch (escolha) {
            ...
            case 2:
                ...
                System.out.println("No final do trilho, encontras umas pegadas e decides segui-las.\n");
                break;
